...
func sampleOpenbazaarConf() (*asset, error) {
	...
	info := bindataFileInfo{name: "sample-openbazaar.conf", size: 8616, mode: os.FileMode(420), modTime: time.Unix(1579653596, 0)}
