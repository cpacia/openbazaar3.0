...
func (*OrderFulfillment_FulfilledItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_e0f5d4cf0fc9e41b, []int{5, 0}
}
...
func (m *OrderFulfillment_FulfilledItem) GetItemIndex() int32 {
	if m != nil {
		return m.ItemIndex
	}
	return 0
...
type OrderFulfillment_FulfilledItem_PhysicalDelivery_ struct {
	PhysicalDelivery *OrderFulfillment_FulfilledItem_PhysicalDelivery `protobuf:"bytes,2,opt,name=physicalDelivery,proto3,oneof"`
}

type OrderFulfillment_FulfilledItem_DigitalDelivery_ struct {
	DigitalDelivery *OrderFulfillment_FulfilledItem_DigitalDelivery `protobuf:"bytes,3,opt,name=digitalDelivery,proto3,oneof"`
}

type OrderFulfillment_FulfilledItem_CryptocurrencyDelivery_ struct {
	CryptocurrencyDelivery *OrderFulfillment_FulfilledItem_CryptocurrencyDelivery `protobuf:"bytes,4,opt,name=cryptocurrencyDelivery,proto3,oneof"`
}
...
func (*OrderFulfillment_FulfilledItem_PhysicalDelivery) Descriptor() ([]byte, []int) {
	return fileDescriptor_e0f5d4cf0fc9e41b, []int{5, 0, 0}
}
...
func (*OrderFulfillment_FulfilledItem_DigitalDelivery) Descriptor() ([]byte, []int) {
	return fileDescriptor_e0f5d4cf0fc9e41b, []int{5, 0, 1}
}
...
func (*OrderFulfillment_FulfilledItem_CryptocurrencyDelivery) Descriptor() ([]byte, []int) {
	return fileDescriptor_e0f5d4cf0fc9e41b, []int{5, 0, 2}
}
...
func (*PaymentSentList_Message) Descriptor() ([]byte, []int) {
	return fileDescriptor_e0f5d4cf0fc9e41b, []int{15, 0}
}
...
func (*FulfillmentList_Message) Descriptor() ([]byte, []int) {
	return fileDescriptor_e0f5d4cf0fc9e41b, []int{16, 0}
}
...
var fileDescriptor_e0f5d4cf0fc9e41b = []byte{
	...
	,
}
